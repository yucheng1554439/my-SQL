...
/*00*/     "create table hey fields  last,       first,         dep,      salary, year",
/*01*/     "insert into hey values Blow,       Joe,           CS,       100000, 2018",
/*02*/     "insert into hey values Blow,       JoAnn,         Physics,  200000, 2016",
/*03*/     "insert into hey values Johnson,    Jack,          HR,       150000, 2014",
/*04*/     "insert into hey values Johnson,    \"Jimmy\",     Chemistry,140000, 2018",

/*05*/     "create table may fields  fname,          lname,    major,    age",
/*06*/     "insert into may values Flo,            Yao, 	Art, 	20",
/*07*/     "insert into may values Bo, 		     Yang, 	CS, 		28",
/*08*/     "insert into may values \"Sammuel L.\", Jackson, 	CS, 		40",
/*09*/     "insert into may values \"Billy\",	     Jackson, 	Math,	27",
/*10*/     "insert into may values \"Mary Ann\",   Davis,	Math,	30",

/*11*/     "select * from hey",
/*12*/     "select last, first, age from hey",
/*13*/     "select last from hey",
/*14*/     "select * from hey where last = Johnson",
/*15*/     "select * from hey where last=Blow and major=\"JoAnn\"",

/*16*/     "select * from may",
/*17*/     "select * from may where (major=CS or major=Art)",
/*18*/     "select * from may where lname>J",
/*19*/     "select * from may where lname>J and (major=CS or major=Art)"
//  select * from student where major=CS or major=Art and lname=   Jackson or lname=Yang or lname = Davis and age = 30
//  select * from student where (major=CS or major=Art) and (lname=   Jackson or lname=Yang or lname = Davis) and age = 30
};
